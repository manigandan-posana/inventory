...
public class AdminController {
    ...
    @GetMapping("/projects")
    public List<ProjectDto> projects(@RequestHeader("X-Auth-Token") String token) {
        ensureAdmin(token);
    ...
    @GetMapping("/users")
    public List<UserDto> listUsers(@RequestHeader("X-Auth-Token") String token) {
        ensureAdmin(token);
        return adminService.listUsers(authService);
    }
